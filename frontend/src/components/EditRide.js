...
const EditRide = () => {
    ...
    function HandleFormSubmit(event) {
        ...
        fetch(`http://localhost:4000/rides/update/${id}`,{
            method: 'put',
        ...
        <Div>
            ...
            <Content>
                <Form onSubmit={(event) => HandleFormSubmit(event)}>
                    <InputDiv>Comuna<Input type="text" value={ride.comuna} onChange={(value) => onChange(value)} name="comuna"/></InputDiv>
                    <InputDiv>Modelo<Input type="text" value={ride.modelo} onChange={(value) => onChange(value)} name="modelo"/></InputDiv>
                    <InputDiv>Patente<Input type="text" value={ride.patente} onChange={(value) => onChange(value)} name="patente"/></InputDiv>
                    <InputDiv>Precio<Input type="number" value={ride.precio} onChange={(value) => onChange(value)} min={0} name="precio"/></InputDiv>
                    <InputDiv>Campus<Select name="campus" onChange={(value) => onChange(value)} value={ride.campus}>
                    ...
                    <InputDiv>Direccion<Select name="direccion" onChange={(value) => onChange(value)} value={ride.direccion}>
